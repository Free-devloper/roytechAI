...
export default function Home() {
  ...
  return (
    <main id="top">
      ...
      <footer className="footer page-pad"><a className="brand" href="#top"><span className="mark"><i /><i /><i /></span>RoyTech<sup>AI</sup></a><p>AI product development, MVP builds, custom software, integrations, and embedded delivery by Rehan Ghafoor for teams that want to keep moving.</p><div><a href="#services">Capabilities</a><a href="#method">Method</a><a href="#estimator">MVP planner</a><a href="#contact">Start a build</a></div><small>© 2026 Rehan Ghafoor · RoyTech AI</small></footer>
    </main>
  );
}
